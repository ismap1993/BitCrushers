...
int main()
{
  ...
  //Creamos una ventana 
    ...
    while (window.isOpen()){  
        ...
        if(sprite.getGlobalBounds().intersects(enemigo1.getGlobalBounds())){
            enemigo1vive=false;
        }
        if(sprite.getGlobalBounds().intersects(enemigo2.getGlobalBounds())){
            enemigo2vive=false;
        }
