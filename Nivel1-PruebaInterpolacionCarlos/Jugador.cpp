...
//        }
    ...
    posicionAnterior.x = posicionJugador.x+1; ///////
    posicionJugador += velocidadJugador;

    
   
    //std::cout<<"posicionJugador: "<<posicionJugador.x;
    //std::cout<<" posicionAnterior: "<<posicionAnterior.x;
    //std::cout<<" Posicion resta: "<<(posicionJugador.x-posicionAnterior.x)<<std::endl;
